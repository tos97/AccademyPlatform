...
public class GlobalParameters {
    ...
    public static final String SRC_PATH                     = File.separator + "src";
    ...
    public static final String CHROME_DRIVER                = BASE_PATH + File.separator + "driver" + File.separator + "chrome" + File.separator + "Windows" + File.separator + "chromedriver.exe";
